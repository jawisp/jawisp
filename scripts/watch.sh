...
# JAVA_CMD="./gradlew run"  # Change to your run command or java -jar
...
cleanup() {
  ...
  # clear unused daemons and logs
  rm ~/.gradle/daemon/9.2.1/registry.bin*
  rm -rf ~/.gradle/daemon/9.2.1/*.out.log 
