...
public enum HttpMethod {
     ...
     * This method replaces all current representations of the target resource with the uploaded content.
     */
    PUT,
     ...
     * This method is used to retrieve meta-information about a resource without transferring the body.
     */
    HEAD,
     ...
     * This method echoes the received request so that a client can see what is being received at each intermediate server.
     */
    TRACE,

    /**
     * CONNECT method - used to establish a tunnel to the server identified by a given host and port.
